    ...
    <table id="working-inv-lines" class="striped">
        ...
        <tfoot>
            <tr>
                ...
                <th style="text-align: right;">{NumberFormat.currency( vm.subtotal, vm.currencyCode )}</th>
            </tr>
            <tr>
                <th colspan="2" style="text-align: right;">GST:</th>
                <th style="text-align: right;">{NumberFormat.currency( vm.taxTotal, vm.currencyCode )}</th>
            </tr>
            <tr>
                <th colspan="2" style="text-align: right;">Grand Total:</th>
                <th style="text-align: right;">{NumberFormat.currency( vm.grandTotal, vm.currencyCode )}</th>
            </tr>
        </tfoot>
    </table>
